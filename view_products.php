              ...
              <div class="table-responsive">
                 <table class="table table-bordered content-table" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include_once ('includes/fetch.php');
                   while($data = mysqli_fetch_array($resultproducts)) {  ?>
                    <tr>
                      ...
                      <td><?php echo $data['product_price']; ?></td>
                       ...
                       <td class="text-center" ><a href="edit_products.php?editproducts=<?php echo $data['product_id']; ?>"><button type="button" class="btn btn-info btn-sm"><i class = "fa fa-edit"></i></button></a>
                        <a href="includes/delete.php?dlproduct=<?php echo $data['product_id']; ?>"><button type="button" class="btn btn-danger btn-sm"><i class = "fa fa-trash"></i></button></a></td>
