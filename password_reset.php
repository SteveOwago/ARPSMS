...
<div class="signup-form">
    ...
    <h2>Reset</h2>
    <p class="hint-text">Please change your password here.</p>
    ...
    <?php
      ...
      <div class="row">
        ...
        <div class="form-group">
          <input type="password" class="form-control" name="oldpassword" placeholder="Original Password">
        </div>
         <div class="form-group">
    ...
    <div class="form-group">
            <button type="submit" name="submit_change" class="btn btn-sm btn-success btn-block">Reset Password</button>
