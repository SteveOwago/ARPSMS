...
if (empty($phone) || empty($address) || empty($scheme_id) || empty($fno) || empty($fsize))
	...
	{
		$sql = "INSERT INTO farms (phone,address,scheme_id,fnumber,farm_size) VALUES('$phone','$address','$scheme_id','$fno','$fsize');";
		$result = mysqli_query($conn,$sql);
