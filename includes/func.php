...
if (isset($_POST['submit'])) {
...

	{
		...
		else
		{
			...
			//Set your existing gmail phone2 as user name
			$mail->Username = 'martinallen722@gmail.com';

			//Set the password of your gmail phone2 here
...
if (empty($phone2) || empty($scheme_id) || empty($fno) || empty($fsize) || empty($user_id) )
		 ...
		 exit();
					...
					{
						$sql = "SELECT * FROM register_db R, farms F WHERE R.user_id = F.user_id AND email = '$fno'";
						$result = mysqli_query($conn,$sql);
