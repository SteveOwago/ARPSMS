                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h6 mb-0 font-weight-bold text-gray-800"><?php echo $first_name;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Last Name</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800"><?php echo $last_name;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Email Address</div>
              ...
              <div class="row">
                <div class="col-lg-6 mb-4">
                  <div class="card bg-primary text-white shadow">
                    <div class="card-body">
                      Farm Id
                      <div class="text-white-50 small"><?php echo $farm_id;?></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                ...
                <div class="col-lg-6 mb-4">
                  <div class="card bg-primary text-white shadow">
                    <div class="card-body">
                      Farm Size
                      <div class="text-white-50 small"><?php echo $farm_size;?></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-success text-white shadow">
                    <div class="card-body">
                      Farm Number
                      <div class="text-white-50 small"><?php echo $fnumber;?></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-primary text-white shadow">
                    <div class="card-body">
                      Farm Address
                      <div class="text-white-50 small"><?php echo $address;?></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-9">
                  <div class="card bg-success text-white shadow">
                    <div class="card-body">
                      Contact Number
                      <div class="text-white-50 small"><?php echo $phone;?></div>
                    </div>
                  </div>
                </div>
              </div>
