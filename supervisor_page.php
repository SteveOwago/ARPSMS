                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                      $schemename= "SELECT scheme_name FROM scheme WHERE sup_id = '".$_SESSION['user_id']."'";
                      $resultscheme = mysqli_query($conn,$schemename);
                      $datascheme = mysqli_fetch_array($resultscheme);
                      ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $datascheme['scheme_name']; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                      $farms= "SELECT * FROM farms WHERE supa_id = '".$_SESSION['user_id']."'";
                      $resultfarms = mysqli_query($conn,$farms);
                      $count = mysqli_num_rows($resultfarms);
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      $countorder = mysqli_num_rows($resultorders);
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                      $pendingorders= "SELECT * FROM orders WHERE status ='0' ";
                      $resultpendingorders = mysqli_query($conn,$pendingorders);
                      $countpending = mysqli_num_rows($resultpendingorders);
