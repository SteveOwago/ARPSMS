...
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBbQvUzMljIxDUIRNAa3CYJr3l4jeVyQKs&libraries=geometry"></script>
            ...
            function initialize() {
              var latlng = new google.maps.LatLng( -0.091702, 34.9163);
              var options = {
                zoom: 100,
                center: latlng,
               ...
               $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.trim() == 1){
                       ...
                       alert('Submitted successfully! Thanks for registering with us!');
                       // window.location.href='http://127.0.0.1/ARPSMS/farmer_page.php';
